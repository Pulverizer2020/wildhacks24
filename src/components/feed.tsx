...
function Feed() {
    ...
    return (
        <div className=" flex flex-col backdrop-blur-3xl min-h-screen justify-center items-center">
            {posts.map((post, index) => (
                <div key={index} className="rounded-xl bg-white overflow-hidden w-full lg:w-4/12 md:w-6/12 text-gray-900 mx-3 md:mx-0 lg:mx-0 mb-4">
                    ...
                    <div className="px-3 pb-2 pt-2">
                        <div class="flex items-center justify-between text-gray-900">
                            <div class="flex items-center space-x-2">
                                <button class="flex justify-center items-center gap-2 px-2 hover:scale-105 duration-150">
                                    <img class="w-5 h-5 fill-current" src={heartIcon}>
                                    </img>
                                    <span>{post.likes} Likes</span>
                                </button>
                            </div>
                            <button class="flex justify-center items-center gap-2 px-2 hover:scale-105 duration-150 rounded-full p-1">
                            ...
                            <button class="flex p-2.5 rounded-xl hover:scale-105 duration-150">
