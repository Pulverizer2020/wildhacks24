    ...
    L.drawVersion = "1.0.4", L.Draw = {}, L.drawLocal = {
            draw: {
                toolbar: {
                    ...
                    buttons: {
                        road: "Draw a road",
                        bike: "Draw a bike lane",
                        publicTransit: "Draw a public transit line",
                        walkway: "Draw a walkway",
                        building: "Draw a building",
                        park: "Draw a park",
                        lake: "Draw a water feature",
                        empty: "Draw an empty lot"
                    }
                },
                handlers: {
                    circle: {
        ...
        }), L.Draw.Polygon4 = L.Draw.Polyline.extend({
            statics: {
                TYPE: "polygon"
            },
            Poly: L.Polygon,
        ...
        }),L.Draw.Polygon3 = L.Draw.Polyline.extend({
            statics: {
                TYPE: "polygon"
            },
            Poly: L.Polygon,
        ...
        }), L.Draw.Polygon2 = L.Draw.Polyline.extend({
            statics: {
                TYPE: "polygon"
            },
            Poly: L.Polygon,
